...
class MenuView(BaseMenu):
    ...
    def __init__(self, name, view=None):
        super().__init__(name, class_name=view.menu_class_name,
    ...
    def get_url(self):
        ...
        _d = self._view._default_view
        _u = '%s.%s' % (self._view.endpoint, _d)
        self._cached_url = self._view.get_url(_u)
        return self._cached_url
...
class MenuLink(BaseMenu):
    ...
    def __init__(self, name, url=None, endpoint=None, category=None,
                 class_name=None, icon_type=None, icon_value=None):
        super().__init__(name, class_name, icon_type, icon_value)
    ...
    def get_url(self):
        # TODO: fix url_for function
        router = self.admin.app.router
        return self.url or router[self.endpoint].url()
