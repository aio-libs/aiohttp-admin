"""Example with dynamically loaded components from a module.
...
async def create_app() -> web.Application:
    ...
    schema: aiohttp_admin.Schema = {
        ...
        "resources": ({"model": SAResource(engine, User), "show_actions": ("CopyUserButton",)},),
        # Use our JS module to include our custom component.
        "js_module": "/static/admin.js"
    }
